                ...
                <div class="form-section">
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" id="name" name="name" placeholder="Name" value="<?= htmlspecialchars($user['name'] ?? '') ?>" required>
                        </div>
                        <div class="form-group">
                ...
                <div class="form-section">
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="ext" name="ext" placeholder="Ext." value="<?= htmlspecialchars($user['ext'] ?? '') ?>">
                        </div>
                    </div>
                </div>
