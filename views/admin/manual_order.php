...
$oldManual = $_SESSION['old_manual_order'] ?? [];
unset($_SESSION['old_manual_order']);
$selectedUserId = (int) ($_POST['user_id'] ?? $_GET['user_id'] ?? $oldManual['user_id'] ?? (!empty($users) ? $users[0]['id'] : 0));
?>
            ...
            <div class="col-lg-5">
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        ...
                        <textarea name="notes" id="notes" class="form-control mb-3" rows="2" placeholder="e.g. 1 Tea Extra Sugar"><?= htmlspecialchars($_POST['notes'] ?? $oldManual['notes'] ?? '') ?></textarea>

                        <label class="form-label" for="room">Room</label>
                        <input type="text" name="room" id="room" class="form-control mb-3" placeholder="Room" value="<?= htmlspecialchars($_POST['room'] ?? $oldManual['room'] ?? '') ?>" required>
